...
/* harmony import */ var _components_count__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/count */ "./src/js/components/count.js");
/* harmony import */ var _components_count__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_components_count__WEBPACK_IMPORTED_MODULE_1__);
...
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.stock__slider', {
  slidesPerView: 2,
  spaceBetween: 10,
  loop: true,
  navigation: {
...
function opemMenu() {
  let list = document.querySelector('.catalog__all');
  list.classList.toggle('open');
}
document.querySelector('.catalog__menu-btn').onclick = opemMenu;
